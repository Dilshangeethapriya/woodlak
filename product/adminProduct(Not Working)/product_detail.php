...
if (isset($_POST['update'])) {
    ...
    if (!empty($image)) {
        ...
        $updateSql = "UPDATE product SET productName='$updateName', description='$updateDescription', price='$updatePrice', image='$target_file' WHERE productID='$productID'";
...
<script>
 ...
 <div>
        ...
        <script>
            ...
            function openUpdateForm(productID,name,price,description,image,stock){
