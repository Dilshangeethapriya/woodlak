    ...
    <body>
        ...
        <div class="row" style="margin-top:20px;">
            <form action="stockReport.php">
                ...
                <a href="export_pdf.php?type=<?php echo isset($_GET['type']) ? $_GET['type'] : ''; ?>" class="button text-md bg-[#6f5843] hover:bg-[#5c4a38] text-white p-2 w-[10%] rounded" style="background-color:#C40C0C; float:right; margin-right: 35px;">Export to PDF &nbsp;<i class="bi bi-filetype-pdf text-l"></i></a>
                <?php endif; ?>
            </form>
        </div>
        </div>
